...
void _launch(int gridX, int gridY, int gridZ, int num_warps, int shared_memory, CUstream stream, CUfunction function, {arg_decls}) {{
  ...
  void *params[] = {{ &arg0, &arg1, &arg3, &arg3, &arg0, &arg0, &arg0, &arg4, &arg4, &arg0, &arg0, &arg0, &arg5, &arg5, &arg0, &arg0, &arg0 }};
  //printf("launch %d, %d, %d, %d, %d, %p, %p\\n", gridX, gridY, gridZ, num_warps, shared_memory, stream, function);
  if(gridX*gridY*gridZ > 0){{
    CUDA_CHECK(cuLaunchKernel(function, gridX, gridY, gridZ, 32*num_warps, 1, 1, shared_memory, stream, params, NULL));
  }}
}}
...
static PyObject* launch(PyObject* self, PyObject* args) {{
  ...
  if(PyErr_Occurred()) {{
    printf("%s\\n", "PyErr_Occurred after call _launch");
    return NULL;
  }}
  if (launch_exit_hook != Py_None) {{
    printf("%s", "before launch_exit_hook\\n");
...
class CudaUtils(object):
    ...
    def _generate_src():
        ...
        static PyObject* loadBinary(PyObject* self, PyObject* args) {
            ...
            printf("%s", "after load data\\n");
            printf("%s %s", "getting func name ", name);
            CUDA_CHECK(cuModuleGetFunction(&fun, mod, name));
            printf("%s", "after get func\\n");
